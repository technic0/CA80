...
#define RESET 5    // GPIO5 for resetting the target microcontroller
#define LED_HB 2   // GPIO2 for Heartbeat (built-in LED)
#define LED_ERR 0  // GPIO0 for Error
#define LED_PMODE 4 // GPIO4 for Programming

#define ARDUINOISP_PIN_MOSI 13 // GPIO13
#define ARDUINOISP_PIN_MISO 12 // GPIO12
#define ARDUINOISP_PIN_SCK 14  // GPIO14
